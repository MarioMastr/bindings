...
class ColorSelectPopup : SetupTriggerPopup, cocos2d::extension::ColorPickerDelegate, GJSpecialColorSelectDelegate {
	...
	static ColorSelectPopup* create(EffectGameObject* effect, cocos2d::CCArray* array, ColorAction* action) = win 0x8c220, imac 0x7320f0;
...
class EditorUI : cocos2d::CCLayer, FLAlertLayerProtocol, ColorSelectDelegate, GJRotationControlDelegate, GJScaleControlDelegate, GJTransformControlDelegate, MusicDownloadDelegate, SetIDPopupDelegate {
	...
	UndoObject* createUndoObject(UndoCommand, bool) = win 0x10d3d0, m1 0x38940, imac 0x3d350;
	...
	void doCopyObjects(bool) = win 0x10f490, m1 0x39c0c, imac 0x3e6d0;
	...
	void moveGamelayer(cocos2d::CCPoint) = win 0xdf250, m1 0x2fba8, imac 0x2f5f0;
	...
	void transformObjectCall(cocos2d::CCObject*) = win 0x11c340; 
	...
	TodoReturn updateGridNodeSize(int) = win 0xdf100, m1 0x2fa1c; 
...
class EndLevelLayer : GJDropDownLayer {
	...
	void goEdit() = win 0x1311d0, m1 0x42bcc4;
	void onEdit(cocos2d::CCObject* sender) = win 0x1310d0, m1 0x42ac7c;
	...
	void onMenu(cocos2d::CCObject* sender) = win 0x130f50, m1 0x42ab78;
...
class EnhancedGameObject : GameObject {
	...
	void updateUserCoin() = win 0x19c930, m1 0x4f958c, imac 0x5ca6b0, imac 0x5ca6b0;
...
class FMODAudioEngine : cocos2d::CCNode {
	...
	void queueStartMusic(gd::string audioFilename, float, float, float, bool, int ms, int, int, int, int, bool, int, bool) = win 0x59a40, m1 0x36a304;
	...
	void setMusicTimeMS(unsigned int ms, bool, int channel) = win 0x5af40, m1 0x365984;
	...
	TodoReturn stopChannel(int, AudioTargetType, bool, float) = win 0x57960; 
	TodoReturn stopChannel(int) = win 0x57960; 
...
class GameLevelManager : cocos2d::CCNode {
	...
	gd::string getActiveDailyID(bool, bool, bool, bool, bool, bool, bool, bool) = m1 0x4af82c; 
	...
	GJGameLevel* getSavedLevel(GJGameLevel*) = win 0x143670, m1 0x490718; 
...
class GameObject : CCSpritePlus {
	...
	void playDestroyObjectAnim(GJBaseGameLayer*) = win 0x1a04e0, m1 0x201d4c, imac 0x25a310;
	void playPickupAnimation(cocos2d::CCSprite*, float, float, float, float, float, float, float, float, bool, float, float) = m1 0x2018d4, win 0x1a0000;
	void playPickupAnimation(cocos2d::CCSprite*, float, float, float, float) = win 0x19ff10, m1 0x20184c, imac 0x259e00;
	...
	bool slopeFloorTop();
	bool slopeWallLeft();
	double slopeYPos(cocos2d::CCRect) = win 0x1973f0; 
	double slopeYPos(float) = win 0x1973f0;
	double slopeYPos(GameObject*) = win 0x1973f0; 
	...
	// void updateMainColor() = win 0x197fb0, m1 0x500864; 
	// void updateSecondaryColor() = win 0x197fc0, m1 0x500d6c; 
...
class GameStatsManager : cocos2d::CCNode {
	...
	gd::string getLevelKey(GJGameLevel* level) = m1 0x60dcc, win inline {
	...
	TodoReturn incrementStat(char const*) = win 0x1ca5b0, m1 0x5ad30;
...
class GameToolbox {
	...
	static CCMenuItemToggler* createToggleButton(gd::string label, cocos2d::SEL_MenuHandler selector, bool state, cocos2d::CCMenu* menu, cocos2d::CCPoint position, cocos2d::CCNode* parent, cocos2d::CCNode* labelParent, cocos2d::CCArray* container) = imac 0x231920, win 0x63080, m1 0x4528d0; 
	...
	static TodoReturn transformColor(cocos2d::ccColor3B const&, float, float, float) = win 0x63ca0; 
}
...
class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
	...
	TodoReturn activatedAudioTrigger(SFXTriggerGameObject*, float) = win 0x231f30, m1 0x1247e0; 
	...
	void activatePlayerControlTrigger(PlayerControlGameObject*) = m1 0xfa46c;
	...
	bool isFlipping();
	bool isPlayer2Button(int param_1) = m1 inline {
		return 5 < param_1;
	}
	...
	TodoReturn recordAction(int, bool, bool) = m1 0x115594;
	...
	cocos2d::CCParticleSystemQuad* spawnParticle(char const*, int, cocos2d::tCCPositionType, cocos2d::CCPoint) = win 0x22f3f0, m1 0x1222ec, imac 0x151480;
	...
	TodoReturn triggerTransformCommand(TransformTriggerGameObject*) = m1 0x105bb0;
...
class GJEffectManager : cocos2d::CCNode {
	...
	TodoReturn createKeyframeCommand(int, cocos2d::CCArray*, GameObject*, int, int, bool, float, float, float, float, float, float, gd::vector<int> const&) = m1 0x278bb0;
	...
	TodoReturn createTransformCommand(double, double, double, double, bool, float, int, int, int, float, bool, bool, int, int) = m1 0x278834;
	...
	TodoReturn playerButton(bool, bool) = win 0x250470, m1 0x27f4f4;
	...
	TodoReturn reset() = win 0x249350, imac 0x2d8fd0;
...
class GJGarageLayer : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol, GameRateDelegate, ListButtonBarDelegate, DialogDelegate, CharacterColorDelegate, RewardedVideoDelegate {
	...
	cocos2d::CCArray* getItems(int, int, IconType, int) = m1 0x2fb2e8, win 0x2647d0, imac 0x36f1c0;
...
class GJRobotSprite : CCAnimatedSprite {
	...
	bool init(int) = win 0x294410, m1 0x50e93c, imac 0x5e5090;
...
class GJTransformControl : cocos2d::CCLayer {
	...
	void updateButtons(bool, bool) = win 0x127460, m1 0x44c3c, imac 0x4b540;
...
class LevelEditorLayer : GJBaseGameLayer, LevelSettingsDelegate {
	...
	TodoReturn getSavedEditorPosition(int) = m1 0xd17c0, imac 0xed160;
	...
	TodoReturn saveEditorPosition(cocos2d::CCPoint&, int) = m1 0xd17a8, imac 0xed140;
	...
	virtual void playerTookDamage(PlayerObject*) = m1 0xd8f10, win 0x2cd520, imac 0xf5f00;
...
class LevelTools {
	...
	static gd::string getAudioFileName(int) = win 0x307cb0, m1 0x4605c4;
...
class MusicSearchResult : cocos2d::CCObject, OptionsObjectDelegate {
	...
	TodoReturn updateObjects() = m1 0x4e9b1c, win 0x325af0;

	virtual TodoReturn updateObjects(AudioSortType) = win 0x325af0, m1 0x4e9b1c, imac 0x5a2410;
...
class PlatformToolbox {
	...
	static void toggleLockCursor(bool) = ios 0x1779c4, m1 0x42d360;
...
class PlayerCheckpoint : cocos2d::CCNode {
	...
	static PlayerCheckpoint* create() = win 0x3979a0, ios 0x122a24, m1 0xa85d0;
...
class PlayerObject : GameObject, AnimatedSpriteDelegate {
	...
	void collidedWithObject(float, GameObject*) = win 0x36fa40, m1 0x38c4ec, imac 0x416340;
	...
	void deactivateStreak(bool) = m1 0x37eab0, imac 0x405d80;
	...
	TodoReturn spawnDualCircle() = m1 0x39213c;
...
class PlayLayer : GJBaseGameLayer, CCCircleWaveDelegate, CurrencyRewardDelegate, DialogDelegate {
	...
	CheckpointObject* createCheckpoint() = win 0x391b00, m1 0xa8020;
	...
	void prepareMusic(bool) = win 0x3972a0, m1 0xa0b3c, imac 0xb3d30;
	...
	void removeAllObjects() = m1 0xa0e18, imac 0xb4000;
	...
	void updateTimeWarp(EffectGameObject*, float) = m1 0xa3594; 
...
class ShaderLayer : cocos2d::CCLayer {
	...
	TodoReturn preChromaticGlitchShader() = imac 0x3d3200, m1 0x354cbc;
	TodoReturn preChromaticShader() = imac 0x3d2f30, m1 0x354a48;
	TodoReturn preColorChangeShader() = imac 0x3d5050;
	TodoReturn preCommonShader() = imac 0x3cfc60, m1 0x352414;
	TodoReturn preGlitchShader() = imac 0x3d29a0, m1 0x354584;
	TodoReturn preGrayscaleShader() = imac 0x3d4b30;
	TodoReturn preHueShiftShader();
	TodoReturn preInvertColorShader();
	TodoReturn preLensCircleShader() = m1 0x355784, imac 0x3d3e70;
	...
	void prePixelateShader() = win 0x45a300, m1 0x355078, imac 0x3d3640;
	TodoReturn preRadialBlurShader() = m1 0x355a20, imac 0x3d4140;
	TodoReturn preSepiaShader();
	TodoReturn preShockLineShader() = m1 0x35416c, imac 0x3d2480;
	TodoReturn preShockWaveShader() = m1 0x353c0c, imac 0x3d1dc0;
	...
	TodoReturn setupChromaticGlitchUniforms() = m1 0x351aac;
	TodoReturn setupChromaticUniforms();
	TodoReturn setupColorChangeShader();
	TodoReturn setupCommonUniforms() = m1 0x3514a4;
	...
	TodoReturn setupLensCircleShader() = m1 0x351bc4;
	...
	void updateEffectOffsets(cocos2d::CCPoint) = win 0x456fb0, m1 0x352640;
...
class Slider : cocos2d::CCLayer {
	...
	static Slider* create(cocos2d::CCNode* target, cocos2d::SEL_MenuHandler handler) = win 0x70230, imac 0x3032c0, m1 0x296c3c {
		return Slider::create(target, handler, 1.f);
	}
	static Slider* create(cocos2d::CCNode* target, cocos2d::SEL_MenuHandler handler, float scale) = win 0x70230, imac 0x3033e0, m1 0x296d40 {
...
class SongInfoLayer : FLAlertLayer {
	...
	static SongInfoLayer* create(gd::string, gd::string, gd::string, gd::string, gd::string, gd::string, int, gd::string, int) = m1 0x5307b0;
	static SongInfoLayer* create(int) = m1 0x530e88;
