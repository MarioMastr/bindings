...
class DrawGridLayer : cocos2d::CCLayer {
    ...
    static DrawGridLayer* create(cocos2d::CCNode*, LevelEditorLayer*) = win 0x2db1f0, m1 0xc4b04, imac 0xdd0d0;
...
class EditGameObjectPopup : SetupTriggerPopup {
    ...
    bool init(EffectGameObject*, cocos2d::CCArray*, bool) = win 0x2938e0, m1 0x23facc;
}
...
class EditorUI : cocos2d::CCLayer, FLAlertLayerProtocol, ColorSelectDelegate, GJRotationControlDelegate, GJScaleControlDelegate, GJTransformControlDelegate, MusicDownloadDelegate, SetIDPopupDelegate {
    ...
    GameObject* createObject(int, cocos2d::CCPoint) = win 0x10e840, m1 0x35d7c, imac 0x3aa80;
...
class GameObject : CCSpritePlus {
    ...
    cocos2d::CCPoint const& getLastPosition() = imac 0x5b2a90, m1 0x4eb730;
...
class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
    ...
    virtual void addToSpeedObjects(EffectGameObject*) = win 0x54c878, m1 0x8fb0, imac 0x7150, ios 0xd590;
    ...
    virtual void checkSnapshot() = m1 0x8fb0, imac 0x7150, ios 0xd590;
    ...
    void checkRepellPlayer() = win 0x233de0, imac 0x143830, m1 0x11a550;
    void checkSpawnObjects() = win 0x215410, imac 0x11c1f0, m1 0xfaa7c;
    ...
    void flipFinished() = m1 inline {
        this->m_player1->levelFlipFinished();
        if (this->m_gameState.m_isDualMode)
            this->m_player2->levelFlipFinished();

        this->m_gameState.m_unkBool11 = 0;
        this->m_gameState.m_unkBool12 = 0;
    }
    ...
    float getMaxPortalY() = win 0x20e2b0, m1 inline {
        if (this->m_gameState.m_unkPoint17.y == 0.0 || this->m_gameState.m_unkBool1)
            return this->getMinPortalY() + (this->m_gameState.m_unkInt11 / this->m_gameState.m_cameraZoom);
        else
            return (this->m_gameState.m_unkPoint33.y + this->m_groundLayer2->getPosition().y + 1.0)
                    / this->m_gameState.m_cameraZoom;
    }
    TodoReturn getMinDistance(cocos2d::CCPoint, cocos2d::CCArray*, float, int) = win 0x23c430;
    float getMinPortalY() = win 0x20e1d0, m1 inline {
        return fmaxf((this->m_gameState.m_cameraOffset.y + this->m_gameState.m_unkInt14
                          + (this->m_gameState.m_unkInt11 * -0.5)
                                  / this->m_gameState.m_cameraZoom),
                    90.0);
    }
    ...
    void processStateObjects() = m1 0xf8dd0;
    ...
    void resumeAudio() = imac inline, m1 0x118fdc {
    ...
    void tryResumeAudio() = imac 0x141e80, m1 0x119024;
    ...
    void updateCollisionBlocks() = imac 0x11a8b0, m1 0xf9468;
    ...
    void updateGradientLayers() = win 0x21a830, imac 0x129310, m1 0x104930;
    TodoReturn updateGroundShadows();
    void updateGuideArt() = win 0x240130, m1 0x11a0e0;
    ...
    void updateQueuedLabels() = m1 0x116170;
    TodoReturn updateReplay();
    float updateSavePositionObjects() = imac 0x11b8b0, m1 0xfa338;
    ...
    void updateSpecialLabels() = win 0x2338f0, m1 0x11c338;
    ...
    void updateTimerLabels() = win 0x22fae0, m1 0x115c94;
...
class GJEffectManager : cocos2d::CCNode {
    ...
    void playerDied();
    void postCollisionCheck() = win 0x254f50, imac 0x2cc390, m1 0x26f040;
    void postMoveActions() = win 0x259470, imac 0x2d4110, m1 0x275628;
    void preCollisionCheck() = imac 0x2cc370, m1 0x26f028;
    void prepareMoveActions(float, bool) = win 0x258060, imac 0x2d16c0, m1 0x27353c;
    ...
    void updateSpawnTriggers(float) = win 0x25aa10, m1 0x276a7c;
    TodoReturn updateTimer(int, double);
    void updateTimers(float, float) = win 0x25b9e0, imac 0x2d82a0, m1 0x2789fc;
...
class GJGameState {
    ...
    void processStateTriggers() = win 0x200290, m1 0xdff70;
    ...
    void updateTweenActions(float) = m1 0xdfca4;
...
class InfoLayer : FLAlertLayer, LevelCommentDelegate, CommentUploadDelegate, FLAlertLayerProtocol {
    ...
    void onRefreshComments(cocos2d::CCObject* sender) = win 0x2b5620, imac 0x79c870, m1 0x6aee78;
...
class PlayerObject : GameObject, AnimatedSpriteDelegate {
    ...
    void levelFlipFinished() = win 0x3759e0, m1 0x372688;
    ...
    void resetCollisionLog(bool) = imac 0x3f2900, m1 0x373520;
    ...
    void resetTouchedRings(bool) = win 0x3824b0, imac 0x4010d0, m1 0x37f644;
    ...
    void updateCheckpointTest() = m1 0x371e70;
    ...
    void updateEffects(float param) = win inline, imac 0x3f0ff0, m1 0x371df0 {
        m_waveTrail->updateStroke(param);
    }
    void updateGlowColor() = win 0x3876a0, imac 0x4088a0, m1 0x386264;
    void updateInternalActions(float) = win 0x38d0c0, imac 0x40b720, m1 0x388d0c;
    ...
    void updateSpecial(float) = imac 0x3f0f70, m1 0x371d78;
...
class SecretRewardsLayer : cocos2d::CCLayer, DialogDelegate, BoomScrollLayerDelegate {
    ...
    bool init(bool) = win 0x3bb300, imac 0x61d6f0, m1 0x54543c;
...
class SetupCameraEdgePopup : SetupTriggerPopup {
    ...
    bool init(CameraTriggerGameObject*, cocos2d::CCArray*) = win 0x3fafd0, m1 0x4c54c0, imac 0x571060;
    void onCameraEdge(cocos2d::CCObject* sender) = win 0x3fbe10;
    void onTargetIDArrow(cocos2d::CCObject* sender) = win 0x3fbf70;
    void onUnlockEdge(cocos2d::CCObject* sender) = win 0x3fbf40;
...
class SetupCameraModePopup : SetupTriggerPopup {
    ...
    static SetupCameraModePopup* create(EffectGameObject*, cocos2d::CCArray*) = win 0x3fc360;
...
class SetupCameraOffsetTrigger : SetupTriggerPopup {
    ...
    void updateMoveCommandPosX() = win 0x3ffaa0;
    void updateMoveCommandPosY() = win 0x3ffb90;
...
class SetupEventLinkPopup : SetupTriggerPopup {
    ...
    bool init(EventLinkTrigger*, cocos2d::CCArray*) = win 0x44d940, m1 0x4b6fa8, imac 0x560620;
...
class SetupGameplayOffsetPopup : SetupTriggerPopup {
    ...
    virtual void updateInputNode(int, float) = m1 0x697468, imac 0x783120, ios 0x1a29e0;
    virtual float triggerValueFromSliderValue(int, float) = m1 0x697418, imac 0x7830d0, ios 0x1a2990;
    virtual float triggerSliderValueFromValue(int, float) = m1 0x697450, imac 0x783100, ios 0x1a29c8;
...
class SetupOptionsTriggerPopup : SetupTriggerPopup {
    ...
    bool init(GameOptionsTrigger*, cocos2d::CCArray*) = win 0x41dcc0, m1 0x502f58, imac 0x5ceaf0;
...
class SetupStaticCameraPopup : SetupTriggerPopup {
    ...
    bool init(CameraTriggerGameObject*, cocos2d::CCArray*) = win 0x447690, m1 0x317c2c, imac 0x3881c0;
...
class SetupTeleportPopup : SetupTriggerPopup {
    ...
    virtual void determineStartValues() = win 0x45c310, imac 0x346b20, m1 0x2db89c, ios 0x1008c;
...
class TeleportPortalObject : RingObject {
    ...
    float getTeleportXOff(cocos2d::CCNode*) = win 0x4998f0, imac 0x1acbd0;
